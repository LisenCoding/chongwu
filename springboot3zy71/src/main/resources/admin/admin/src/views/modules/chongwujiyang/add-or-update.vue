<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="宠物分类" prop="chongwufenlei">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否进食" prop="shifoujinshi">
          <el-select :disabled="ro.shifoujinshi" v-model="ruleForm.shifoujinshi" placeholder="请选择是否进食">
            <el-option
                v-for="(item,index) in shifoujinshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否进食" prop="shifoujinshi">
	      <el-input v-model="ruleForm.shifoujinshi"
                placeholder="是否进食" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否饮水" prop="shifouyinshui">
          <el-select :disabled="ro.shifouyinshui" v-model="ruleForm.shifouyinshui" placeholder="请选择是否饮水">
            <el-option
                v-for="(item,index) in shifouyinshuiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否饮水" prop="shifouyinshui">
	      <el-input v-model="ruleForm.shifouyinshui"
                placeholder="是否饮水" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.nianling = true;
          ...
          if(o=='shifoujinshi'){
            this.ruleForm.shifoujinshi = obj[o];
	    this.ro.shifoujinshi = true;
            continue;
          }
	    ...
	    this.ro.chongwuzhuangtai = true;
          ...
          if(o=='shifouyinshui'){
            this.ruleForm.shifouyinshui = obj[o];
	    this.ro.shifouyinshui = true;
            continue;
          }
          if(o=='jiyangyuanyin'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/chongwufenlei/chongwufenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
            ...
            this.shifoujinshiOptions = "是,否".split(',')
            this.chongwuzhuangtaiOptions = "正常,异常".split(',')
            this.shifouyinshuiOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.chongwuxiangqing = this.ruleForm.chongwuxiangqing.replace(reg,'../../../springboot3zy71/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
