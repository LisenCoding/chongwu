      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "#003153"
          })
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = "linear-gradient(135deg, #f5f5f5 0%, #f5f5f5 70%, #003153 70%, #003153 100%)"
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: linear-gradient(135deg, #f5f5f5 0%, #f5f5f5 78%, #003153 78%, #003153 100%) !important;
